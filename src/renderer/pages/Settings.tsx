    ...
    <div className="page">
      <div className="fade-in">
        ...
        <div className="surface">
          ...
          <div className="setting-block">
            <div className="setting-label">文中语音</div>
            <div className="setting-hint">
              文章里带语音时一并下载（和图片一样，属于文章内容，无需在格式里勾选）。
              单条通常数百 KB——按公众号批量抓取前想省流量可以关掉。
            </div>
            <Space align="center">
              <Switch checked={s.downloadAudios} data-testid="set-download-audios"
                onChange={(v) => setS({ ...s, downloadAudios: v })} />
              <span className="faint">{s.downloadAudios ? '有语音就下载' : '跳过语音（正文会注明"含语音未下载"）'}</span>
            </Space>
          </div>
